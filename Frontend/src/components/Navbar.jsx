...
import { FaUser, FaCompass, FaHome, FaHighlighter, FaCog, FaSignOutAlt } from "react-icons/fa";
  ...
  return (
    <div className="flex h-screen">
      ...
      <aside className="bg-[#E7E7E4] w-72 h-full px-12 py-16 flex flex-col">
        <h1 className="text-2xl font-semibold mb-12 font-secondary">BookLink</h1>
